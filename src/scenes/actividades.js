...
export default class actividadesScene extends Phaser.Scene {
    constructor() {
        super({ key: "actividadesScene" });
    }   
    create() {
        this.add.image(960, 540, 'fondoActvidades');
        ...
        const logoCarhue = this.add.image(120, 50, 'logoCarhue');
              ...
              let txtReserva = this.add.text(790,80, textData.txtActividades, {fontFamily:  'Metropolis-Bold, "Times New Roman", Tahoma, serif', fontSize: 60, color: '#ffffff '});

              let txtEpecuen = this.add.text(280, 280, 'Actividades y paseos', {fontFamily:  'Metropolis-Bold, "Times New Roman", Tahoma, serif', fontSize: 30, color: '#000000 '});

let txtDescripEpecuen = this.add.text(280, 330, "Carhué ofrece al visitante multiplicidad de opciones para el esparcimiento, entre las cuales podemos destacar el Camping La Chacra, el Museo Regional Dr. Adolfo Alsina, las obras del Arq. Salamone y el Centro de Interpretación de la Villa Lago Epecuén.", {
...
let txtDescripEpecuen1 = this.add.text(280, 450, "También podrá disfrutar de obras de teatro, shows y films en el Cine Teatro de la Sociedad Española y de actividades culturales en la Casa de la Cultura y el Espacio Cultural La Dama.", {
  fontFamily: 'Metropolis, "Times New Roman", Tahoma, serif',
  fontSize: 20,
  color: '#000000',
  wordWrap: {
...
let imgRuinas = this.add.image(1205, 680, 'imgActividades');
    ...
    let txtbotonruinas = this.add.text(350, 675, 'Conoce todas las actividades', {
