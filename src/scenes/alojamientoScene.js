...
export default class alojamientoScene extends Phaser.Scene {
    constructor() {
        super({ key: "alojamientoScene" });
    }   
    create() {
        ...
        const logoCarhue = this.add.image(120, 50, 'logoCarhue');
              ...
              let txtReserva = this.add.text(800,80, textData.txtAlojamiento, {fontFamily:  'Metropolis-Bold, "Times New Roman", Tahoma, serif', fontSize: 60, color: '#ffffff '});
