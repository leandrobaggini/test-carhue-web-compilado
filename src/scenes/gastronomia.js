...
export default class gastronomiaScene extends Phaser.Scene {
    constructor() {
        super({ key: "gastronomiaScene" });
    }   
    create() {
        ...
        const logoCarhue = this.add.image(120, 50, 'logoCarhue');
              ...
              let txtReserva = this.add.text(800,80, textData.txtGastronomia, {fontFamily:  'Metropolis-Bold, "Times New Roman", Tahoma, serif', fontSize: 60, color: '#ffffff '});
              ...
              panel.add([fondoBlanco, txtReserva]);
...
// Texto que se mostrará cuando el cursor pase por encima
let textoTrans = this.add.text(1035, 1025, 'Transporte', {
  font: '14px Metropolis',
  fill: '#ffffff',
  });
  textoTrans.setVisible(false);
